...
// .mq.UserType user_type = 4;
inline void basicCommonResponce::clear_user_type() {
  user_type_ = 0;
}
inline ::mq::UserType basicCommonResponce::_internal_user_type() const {
  return static_cast< ::mq::UserType >(user_type_);
}
inline ::mq::UserType basicCommonResponce::user_type() const {
  // @@protoc_insertion_point(field_get:mq.basicCommonResponce.user_type)
  return _internal_user_type();
}
inline void basicCommonResponce::_internal_set_user_type(::mq::UserType value) {
  
  user_type_ = value;
}
inline void basicCommonResponce::set_user_type(::mq::UserType value) {
  _internal_set_user_type(value);
  // @@protoc_insertion_point(field_set:mq.basicCommonResponce.user_type)
}
