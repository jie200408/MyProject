...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_proto_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::mq::basicCommonResponce, user_type_),
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_proto_2eproto = {
  false, false, descriptor_table_protodef_proto_2eproto, "proto.proto", 1580,
  &descriptor_table_proto_2eproto_once, descriptor_table_proto_2eproto_sccs, descriptor_table_proto_2eproto_deps, 16, 2,
...
basicCommonResponce::basicCommonResponce(const basicCommonResponce& from)
  ...
  ::memcpy(&ok_, &from.ok_,
    ...
    reinterpret_cast<char*>(&ok_)) + sizeof(user_type_));
...
void basicCommonResponce::InternalSwap(basicCommonResponce* other) {
  ...
  cid_.Swap(&other->cid_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(basicCommonResponce, user_type_)
      + sizeof(basicCommonResponce::user_type_)
      - PROTOBUF_FIELD_OFFSET(basicCommonResponce, ok_)>(
